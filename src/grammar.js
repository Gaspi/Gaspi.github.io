...
var grammar = {
    ...
    {"name": "line", "symbols": [(lexer.has("CMD_REQ") ? {type: "CMD_REQ"} : CMD_REQ), (lexer.has("ID") ? {type: "ID"} : ID), (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,id               ,e]) => CmdReq(e.line,id)},
    {"name": "line", "symbols": [(lexer.has("CMD_REQ") ? {type: "CMD_REQ"} : CMD_REQ), (lexer.has("QID") ? {type: "QID"} : QID), (lexer.has("LEFTSQU") ? {type: "LEFTSQU"} : LEFTSQU), (lexer.has("ID") ? {type: "ID"} : ID), (lexer.has("RIGHTSQU") ? {type: "RIGHTSQU"} : RIGHTSQU), (lexer.has("END") ? {type: "END"} : END)], "postprocess": ([,id,,alias,       ,e]) => CmdReq(e.line,id,alias)},
